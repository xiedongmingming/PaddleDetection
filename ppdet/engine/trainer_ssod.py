    ...
    def _update_teacher_model(self, keep_rate=0.996):
        ...
        for key, value in self.model.modelTeacher.state_dict().items():
            ...
            if key in student_model_dict.keys():
                ...
                v = student_model_dict[key] * (1 - keep_rate) + value * keep_rate
...
class Trainer_Semi_RTDETR(Trainer):
    ...
    def __init__(self, cfg, mode='train'):
        ...
        if self.mode == 'train':
            ...
            self.dataset_unlabel = self.cfg['UnsupTrainDataset'] = create('UnsupTrainDataset')
    ...
    def train(self, validate=False):
        ...
        for epoch_id in range(self.start_epoch, self.cfg.epoch):
            ...
            for step_id in range(len(self.loader)):
                ...
                if validate and (self._nranks < 2 or self._local_rank == 0) and ((iter_id + 1) % self.cfg.eval_interval == 0):
